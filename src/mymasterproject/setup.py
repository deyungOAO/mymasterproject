...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', 'mymasterproject', 'launch'), glob('launch/*.launch.py')),
    ],
    scripts=glob('scripts/*.py'),
    install_requires=['setuptools'],
    zip_safe=True,
    maintainer='deyung',
    maintainer_email='deyung000@gmail.com',
    ...
    entry_points={
        'console_scripts': [
            ...
            'dwa_local_planner.py = mymasterproject.dwa_local_planner:main',
            'prm_planner.py = mymasterproject.prm_planner:main',
            'newcar_launch.py = mymasterproject.newcar_launch:main'
        ],
    },
)
